...
func (c *userAuthServiceClient) Register(ctx context.Context, in *AuthRegister, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	//cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserAuthServiceServer) Register(context.Context, *AuthRegister) (*emptypb.Empty, error) {
